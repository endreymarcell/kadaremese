  ...
  <Layout>
    <ArticleLayout>
      ...
      <div className={style.articleContainer}>
        <h1 className={style.articleTitle}>Őrlődés</h1> <h2 className={style.articleSubtitle}>2017</h2>
        <br />
...
export const query = graphql`
  query ArticleQueryOrlodes {
    allFile(filter: {relativeDirectory: {eq: "installaciok/orlodes"}}, sort: {fields: base}) {
      edges {
        node {
          base
          childImageSharp {
